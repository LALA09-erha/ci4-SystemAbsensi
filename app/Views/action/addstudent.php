        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <h2 class="heading-section">ADD STUDENT </h2>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-5">
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <form action="/prosesaddstudent" method="POST" class="login-form">
                            <?= csrf_field() ?>
                            <div class="form-group">
                                <input type="hidden" name="iduser" class="form-control rounded-left" required
                                    value=<?php echo $_SESSION['id'] ?>>
                                <input type="number" name="nim" class="form-control rounded-left" placeholder="NIM"
                                    required>
                                <input type="text" name="nama" class="form-control rounded-left mt-3" placeholder="NAME STUDENT"
                                    required>
                            </div>
                            <?php
